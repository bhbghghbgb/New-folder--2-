...
public class Main {
    ...
    public static int load() {
        try {
            Global.cards = Cards
                    .fromBatchBlob(PFTrim(new PFFileReader("mini-library-manager","quanlythuvien", "data", "List_The.csv").read()));
            Global.authors = Authors
                    .fromBatchBlob(PFTrim(new PFFileReader("mini-library-manager","quanlythuvien", "data", "List_TacGia.csv").read()));
            Global.documents = Documents
                    .fromBatchBlob(PFTrim(new PFFileReader("mini-library-manager","quanlythuvien", "data", "List_TaiLieu.csv").read()));
            Global.readers = Readers
                    .fromBatchBlob(PFTrim(new PFFileReader("mini-library-manager","quanlythuvien", "data", "List_DocGia.csv").read()));
            Global.cashiers = Cashiers
                    .fromBatchBlob(PFTrim(new PFFileReader("mini-library-manager","quanlythuvien", "data", "List_NhanVien.csv").read()));
            Global.managers = Managers
                    .fromBatchBlob(PFTrim(new PFFileReader("mini-library-manager","quanlythuvien", "data", "List_QuanLi.csv").read()));
            Global.hoadons = HoaDons
                    .fromBatchBlob(PFTrim(new PFFileReader("mini-library-manager","quanlythuvien", "data", "List_HoaDon.csv").read()));
    ...
    public static int save() {
        try {
            ...
            new PFFileWriter("mini-library-manager","quanlythuvien", "data", "List_HoaDon_data.csv").write(Global.hoadons.toBatchBlob());
